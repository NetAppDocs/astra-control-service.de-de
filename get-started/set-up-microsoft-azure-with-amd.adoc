...
Azure Region:: Als Best Practice sollte eine Region gewählt werden, die Azure NetApp Files unterstützt, auch wenn Sie sie nicht als Storage-Backend verwenden. Dadurch ist es einfacher, Azure NetApp Files zukünftig als Storage-Backend zu verwenden, wenn sich Ihre Performance-Anforderungen ändern. https://["Hier finden Sie Azure Produkte nach Region"^].
...
.Schritt
. Gehen Sie zu https://["Die Microsoft CSI-Treiberdokumentation"^].
