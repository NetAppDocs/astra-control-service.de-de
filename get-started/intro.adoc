...
| Welche Funktionen stehen für das Applikationsdatenmanagement zur Verfügung? | Dieselben Funktionen auf beiden Plattformen, mit Ausnahme des Storage-Backend oder zu externen Services (siehe <<Funktionen>>)  a| 
Dieselben Funktionen auf beiden Plattformen, mit Ausnahme des Storage-Backend oder zu externen Services (siehe <<Funktionen>>)
