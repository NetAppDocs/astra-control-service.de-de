...
* Wenn Sie NetApp Storage nutzen oder nutzen möchten, stellen Sie sicher, dass Sie eine Version von Astra Trident installiert haben link:../get-started/requirements.html#operational-environment-requirements["Unterstützt durch den Astra Control Service"^]:
+
