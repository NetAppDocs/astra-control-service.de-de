...
Stellen Sie sicher, dass die Cluster ordnungsgemäß sind und eine unterstützte Kubernetes-Version ausführen, dass Worker-Nodes online sind und Container-optimiertes OS oder Ubuntu ausführen usw.  cluster requirements,Erfahren Sie mehr zu diesem Schritt.
...
Kubernetes-Version:: Auf einem Cluster muss eine Kubernetes-Version im Bereich von 1.20 bis 1.23 ausgeführt werden.
Bildtyp:: Der Bildtyp für jeden Arbeiterknoten muss einer der folgenden Werte sein:
+
--
* Container-optimiertes OS mit Containerd
* Für Container optimiertes OS mit Docker
* Ubuntu mit Docker
