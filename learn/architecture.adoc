...
* *Speicher-Backend*:
+
** Astra Control Service verwendet https://www.netapp.com/cloud-services/azure-netapp-files/["Azure NetApp Dateien"^], Von Azure verwaltete Festplatten und https://www.netapp.com/cloud-services/cloud-volumes-ontap/what-is-cloud-volumes/["NetApp Cloud Volumes ONTAP"] Als Storage-Back-Ends für AKS-Cluster.
** Astra Control Service verwendet https://www.netapp.com/cloud-services/cloud-volumes-service-for-google-cloud/["NetApp Cloud Volumes Service für Google Cloud"^], Google Persistent Disk, und https://www.netapp.com/cloud-services/cloud-volumes-ontap/what-is-cloud-volumes/["NetApp Cloud Volumes ONTAP"] Als Speicher-Back-Ends für GKE-Cluster.
** Astra Control Service verwendet https://docs.aws.amazon.com/ebs/["Amazon Elastic Block Store"^] Und https://docs.aws.amazon.com/fsx/["Amazon FSX für NetApp ONTAP"^] Als Storage-Back-Ends für AWS Cluster.
