...
* Unterstützung von NetApp Cloud Volumes ONTAP als Storage-Backend (offiziell auf Microsoft Azure und Google Cloud Plattformen unterstützt)
+
link:../learn/architecture.html#astra-control-components["Architektur und Komponenten"]
