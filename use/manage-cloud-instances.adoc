...
Wenn Sie dem Astra Control ein neues Cluster hinzufügen, können Sie eine neue Cloud-Instanz hinzufügen. Siehe link:../add-first-cluster.html["Managen Sie Kubernetes Cluster über den Astra Control Service"] Finden Sie weitere Informationen.
